...
- Upload assets with smart features. ([CLI](../cli/reference.md#immichpy-assets-upload), [Client](../client/reference/custom/assets_api_wrapped.md#immichpy.client.wrapper.assets_api_wrapped.AssetsApiWrapped.upload))
