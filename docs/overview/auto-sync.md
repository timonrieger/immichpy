...
**immichpy** stays in sync with upstream Immich automatically. When Immich releases a new version, a workflow opens a pull request with the updates, which is then merged by a maintainer.
