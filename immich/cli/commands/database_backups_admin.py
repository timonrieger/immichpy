...
def delete_database_backup(
    ...
    result = run_command(client, client.backups, 'delete_database_backup', ctx, **kwargs)
    print_response(result, ctx)

@app.command("download-database-backup", deprecated=False, rich_help_panel="API commands")
def download_database_backup(
    ...
    client: 'AsyncClient' = ctx.obj['client']
    result = run_command(client, client.backups, 'download_database_backup', ctx, **kwargs)
    print_response(result, ctx)
...
@app.command("start-database-restore-flow", deprecated=False, rich_help_panel="API commands")
def start_database_restore_flow(
    ...
    kwargs = {}
    client: 'AsyncClient' = ctx.obj['client']
    result = run_command(client, client.backups, 'start_database_restore_flow', ctx, **kwargs)
    print_response(result, ctx)
...
def upload_database_backup(
    ...
    client: 'AsyncClient' = ctx.obj['client']
    result = run_command(client, client.backups, 'upload_database_backup', ctx, **kwargs)
    print_response(result, ctx)
