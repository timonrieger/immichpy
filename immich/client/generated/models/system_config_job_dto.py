...
class SystemConfigJobDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["backgroundTask", "editor", "faceDetection", "library", "metadataExtraction", "migration", "notifications", "ocr", "search", "sidecar", "smartSearch", "thumbnailGeneration", "videoConversion", "workflow"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "editor": JobSettingsDto.from_dict(obj["editor"]) if obj.get("editor") is not None else None,
