...
class QueuesResponseLegacyDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["backgroundTask", "backupDatabase", "duplicateDetection", "editor", "faceDetection", "facialRecognition", "library", "metadataExtraction", "migration", "notifications", "ocr", "search", "sidecar", "smartSearch", "storageTemplateMigration", "thumbnailGeneration", "videoConversion", "workflow"]
