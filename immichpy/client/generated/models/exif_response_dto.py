...
class ExifResponseDto(BaseModel):
    ...
    exif_image_width: Optional[
        Annotated[int, Field(le=9007199254740991, strict=True, ge=0)]
    ] = Field(default=None, description="Image width in pixels", alias="exifImageWidth")
    ...
    file_size_in_byte: Optional[
        Annotated[int, Field(le=9007199254740991, strict=True, ge=0)]
    ] = Field(default=None, description="File size in bytes", alias="fileSizeInByte")
    ...
    ] = Field(default=None, description="ISO sensitivity")
