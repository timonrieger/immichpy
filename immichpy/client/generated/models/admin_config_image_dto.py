        ...
        _obj = cls.model_validate(
            {
                ...
                "fullsize": AdminConfigGeneratedFullsizeImageDto.from_dict(
                    obj["fullsize"]
                )
                if obj.get("fullsize") is not None
                else None,
                "preview": AdminConfigGeneratedImageDto.from_dict(obj["preview"])
                if obj.get("preview") is not None
                else None,
                "thumbnail": AdminConfigGeneratedImageDto.from_dict(obj["thumbnail"])
