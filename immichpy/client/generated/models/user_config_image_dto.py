...
class UserConfigImageDto(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "fullsize": UserConfigGeneratedFullsizeImageDto.from_dict(
                    obj["fullsize"]
                )
                if obj.get("fullsize") is not None
                else None,
                "preview": UserConfigGeneratedImageDto.from_dict(obj["preview"])
                if obj.get("preview") is not None
                else None,
                "thumbnail": UserConfigGeneratedImageDto.from_dict(obj["thumbnail"])
