...
class AssetResponseDto(BaseModel):
    ...
    duplicate_id: Optional[UUID] = Field(
    ...
    height: Optional[Annotated[int, Field(le=9007199254740991, strict=True, ge=0)]] = (
    ...
    width: Optional[Annotated[int, Field(le=9007199254740991, strict=True, ge=0)]] = (
