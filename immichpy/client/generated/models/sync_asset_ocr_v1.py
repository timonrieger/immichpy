...
class SyncAssetOcrV1(BaseModel):
    ...
    box_score: Union[StrictFloat, StrictInt] = Field(
        description="Confidence score of the bounding box", alias="boxScore"
    )
    id: UUID = Field(description="OCR entry ID")
    is_visible: StrictBool = Field(
        description="Whether the OCR entry is visible", alias="isVisible"
    )
    text: StrictStr = Field(description="Recognized text content")
    text_score: Union[StrictFloat, StrictInt] = Field(
        description="Confidence score of the recognized text", alias="textScore"
    )
