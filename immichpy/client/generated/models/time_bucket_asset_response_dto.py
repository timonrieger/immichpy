...
class TimeBucketAssetResponseDto(BaseModel):
    ...
    city: Optional[List[Optional[StrictStr]]] = Field(
        default=None, description="Array of city names extracted from EXIF GPS data"
    )
    country: Optional[List[Optional[StrictStr]]] = Field(
        default=None, description="Array of country names extracted from EXIF GPS data"
    )
    created_at: List[StrictStr] = Field(
