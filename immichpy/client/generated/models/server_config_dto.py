...
class ServerConfigDto(BaseModel):
    ...
    oauth_account_management_url: Optional[StrictStr] = Field(
        default="",
        description="OAuth account management URL",
        alias="oauthAccountManagementUrl",
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "oauthAccountManagementUrl": obj.get("oauthAccountManagementUrl")
                if obj.get("oauthAccountManagementUrl") is not None
                else "",
