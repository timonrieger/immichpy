...
class SyncAssetFaceV2(BaseModel):
    ...
    bounding_box_x1: Annotated[
        int, Field(le=9007199254740991, strict=True, ge=-9007199254740991)
    ] = Field(description="Bounding box X1", alias="boundingBoxX1")
    bounding_box_x2: Annotated[
        int, Field(le=9007199254740991, strict=True, ge=-9007199254740991)
    ] = Field(description="Bounding box X2", alias="boundingBoxX2")
    bounding_box_y1: Annotated[
        int, Field(le=9007199254740991, strict=True, ge=-9007199254740991)
    ] = Field(description="Bounding box Y1", alias="boundingBoxY1")
    bounding_box_y2: Annotated[
        int, Field(le=9007199254740991, strict=True, ge=-9007199254740991)
    ] = Field(description="Bounding box Y2", alias="boundingBoxY2")
    ...
    image_height: Annotated[
        int, Field(le=9007199254740991, strict=True, ge=-9007199254740991)
    ] = Field(description="Image height", alias="imageHeight")
    image_width: Annotated[
        int, Field(le=9007199254740991, strict=True, ge=-9007199254740991)
    ] = Field(description="Image width", alias="imageWidth")
