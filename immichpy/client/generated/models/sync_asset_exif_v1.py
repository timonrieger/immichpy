...
class SyncAssetExifV1(BaseModel):
    ...
    exif_image_height: Optional[
        Annotated[int, Field(le=9007199254740991, strict=True, ge=-9007199254740991)]
    ] = Field(description="Exif image height", alias="exifImageHeight")
    exif_image_width: Optional[
        Annotated[int, Field(le=9007199254740991, strict=True, ge=-9007199254740991)]
    ] = Field(description="Exif image width", alias="exifImageWidth")
    ...
    file_size_in_byte: Optional[
        Annotated[int, Field(le=9007199254740991, strict=True, ge=-9007199254740991)]
    ] = Field(description="File size in byte", alias="fileSizeInByte")
