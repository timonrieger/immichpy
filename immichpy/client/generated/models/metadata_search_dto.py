...
class MetadataSearchDto(BaseModel):
    ...
    cursor: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(
    ...
    size: Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]] = Field(
        default=250, description="Number of results to return"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "filter": SearchFilter.from_dict(obj["filter"])
                ...
                "ocr": obj.get("ocr"),
                "order": obj.get("order"),
                "orderBy": SearchOrder.from_dict(obj["orderBy"])
