...
from immichpy.client.generated.models.asset_edit_action_list_dto_edits_inner import AssetEditActionListDtoEditsInner
...
class AssetEditsDto(BaseModel):
    ...
    edits: Annotated[List[AssetEditActionListDtoEditsInner], Field(min_length=1)] = Field(description="list of edits")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "edits": [AssetEditActionListDtoEditsInner.from_dict(_item) for _item in obj["edits"]] if obj.get("edits") is not None else None
        })
        return _obj
