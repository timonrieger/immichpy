...
class AlbumStatisticsResponseDto(BaseModel):
    ...
    not_shared: Annotated[int, Field(le=9007199254740991, strict=True, ge=0)] = Field(
        description="Number of non-shared albums", alias="notShared"
    )
    owned: Annotated[int, Field(le=9007199254740991, strict=True, ge=0)] = Field(
        description="Number of owned albums"
    )
    shared: Annotated[int, Field(le=9007199254740991, strict=True, ge=0)] = Field(
