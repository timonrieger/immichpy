...
class DeprecatedApi:
    ...
    async def merge_person_legacy(
        ...
        :return: Returns the result object.
        """  # noqa: E501
        warnings.warn("POST /people/{id}/merge is deprecated.", DeprecationWarning)

        _param = self._merge_person_legacy_serialize(
            id=id,
    ...
    @validate_call
    async def merge_person_legacy_with_http_info(
        self,
        id: UUID,
        merge_person_dto: MergePersonDto,
        _request_timeout: Union[
    ...
    @validate_call
    async def merge_person_legacy_without_preload_content(
        self,
        id: UUID,
        merge_person_dto: MergePersonDto,
        _request_timeout: Union[
    ...
    def _merge_person_legacy_serialize(
        self,
        id,
        merge_person_dto,
        _request_auth,
