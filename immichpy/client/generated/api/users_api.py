...
class UsersApi:
    ...
    async def get_my_calendar_heatmap(
        self,
        var_from: Annotated[
            Optional[date], Field(description="Start date in UTC")
        ] = None,
    ...
    @validate_call
    async def get_my_calendar_heatmap_with_http_info(
        self,
        var_from: Annotated[
            Optional[date], Field(description="Start date in UTC")
        ] = None,
    ...
    @validate_call
    async def get_my_calendar_heatmap_without_preload_content(
        self,
        var_from: Annotated[
            Optional[date], Field(description="Start date in UTC")
        ] = None,
