...
class UsersAdminApi:
    ...
    @validate_call
    async def get_user_calendar_heatmap_admin(
        self,
        id: UUID,
        var_from: Annotated[
    ...
    @validate_call
    async def get_user_calendar_heatmap_admin_with_http_info(
        self,
        id: UUID,
        var_from: Annotated[
            Optional[date], Field(description="Start date in UTC")
    ...
    @validate_call
    async def get_user_calendar_heatmap_admin_without_preload_content(
        self,
        id: UUID,
        var_from: Annotated[
            Optional[date], Field(description="Start date in UTC")
