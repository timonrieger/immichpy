...
class AlbumsApi:
    ...
    @validate_call
    async def get_album_map_markers_with_http_info(
        self,
        id: UUID,
        key: Optional[StrictStr] = None,
        slug: Optional[StrictStr] = None,
    ...
    @validate_call
    async def get_album_map_markers_without_preload_content(
        self,
        id: UUID,
        key: Optional[StrictStr] = None,
        slug: Optional[StrictStr] = None,
    ...
    async def get_all_albums(
        ...
        name: Annotated[
            Optional[StrictStr], Field(description="Album name (exact match)")
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    async def remove_user_from_album(
        ...
        user_id: Annotated[
            StrictStr,
            Field(description='Album user ID, or "me" to reference the current user.'),
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
