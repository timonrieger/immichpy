...
class PeopleApi:
    ...
    async def get_all_people(
        ...
        page: Annotated[
            Optional[Annotated[int, Field(le=9007199254740991, strict=True, ge=1)]],
    ...
    async def merge_people(
        ...
        _param = self._merge_people_serialize(
    ...
    @validate_call
    async def merge_people_with_http_info(
        self,
        merge_person_dto: MergePersonDto,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def merge_people_without_preload_content(
        self,
        merge_person_dto: MergePersonDto,
        _request_timeout: Union[
            None,
