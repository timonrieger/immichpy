...
class WorkflowsApi:
    ...
    @validate_call
    async def get_workflow_for_share(
        self,
        id: UUID,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_workflow_for_share_with_http_info(
        self,
        id: UUID,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_workflow_for_share_without_preload_content(
        self,
        id: UUID,
        _request_timeout: Union[
            None,
    ...
    async def get_workflow_logs(
        ...
        id: UUID,
        before: Annotated[
            Optional[datetime], Field(description="Filter by runs before a date/time")
        ] = None,
        limit: Annotated[
        ...
        result: Annotated[
            Optional[WorkflowResult], Field(description="Filter by run result")
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_workflow_logs_with_http_info(
        self,
        id: UUID,
        before: Annotated[
            Optional[datetime], Field(description="Filter by runs before a date/time")
    ...
    @validate_call
    async def get_workflow_logs_without_preload_content(
        self,
        id: UUID,
        before: Annotated[
            Optional[datetime], Field(description="Filter by runs before a date/time")
    ...
    @validate_call
    async def get_workflow_triggers_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_workflow_triggers_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    async def search_workflows(
        ...
        description: Annotated[
            Optional[StrictStr], Field(description="Workflow description")
        ] = None,
        enabled: Annotated[
            Optional[StrictBool], Field(description="Workflow enabled")
        ] = None,
        id: Annotated[Optional[UUID], Field(description="Workflow ID")] = None,
        logging: Annotated[
            Optional[StrictBool], Field(description="Workflow logs run results")
        ] = None,
        name: Annotated[Optional[StrictStr], Field(description="Workflow name")] = None,
        trigger: Annotated[
            Optional[WorkflowTrigger], Field(description="Workflow trigger type")
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def search_workflows_with_http_info(
        self,
        description: Annotated[
            Optional[StrictStr], Field(description="Workflow description")
        ] = None,
    ...
    @validate_call
    async def search_workflows_without_preload_content(
        self,
        description: Annotated[
            Optional[StrictStr], Field(description="Workflow description")
        ] = None,
